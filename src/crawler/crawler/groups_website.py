"""
Groups website get from mangaupdates-urlfix
Credits to loadletter for the links.

https://github.com/loadletter/mangaupdates-urlfix/blob/master/mangaupdates_group.user.js
"""
...
class Groups:
	...
	def __init__(self):
		self.pattern = re.compile(ur'groups = \{.*\}', re.DOTALL)
	...
	def load_website(self):
		if(self.groups == None):
			try:
				response = urllib2.urlopen('https://raw.githubusercontent.com/loadletter/mangaupdates-urlfix/master/mangaupdates_urlfix.user.js')
				data = response.read()
				m = re.match(self.pattern, data)
				data = m.group(0).replace('groups = ','')
				self.groups = json.loads(data)
				
				
			except:
				print "Error on load_groups"
			self.groups = {
			...
			"2963": "http://mangahelpers.com/s/ivalice",
			...
			"3161": "http://ichigoichiescans.byethost9.com/",
			...
			"3181": "http://mangahelpers.com/s/the-black-widow",
			...
			"3283": "http://mangahelpers.com/s/zgames",
			...
			"3351": "http://mangahelpers.com/s/ringo-scans",
			...
			"4094": "http://www.earths-utopia.info/",
			...
			"4150": "http://www.elusivescans.net/",
			...
			"4743": "http://precuremanga.blogspot.pt/",
