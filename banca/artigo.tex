...
\begin{figure}[H]
\centering
\includegraphics[height=0.85\textheight, width=0.85\textwidth]{MER_-_Collection.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.92\textheight,width=0.72\textwidth]{MER_-_Country-Language-Currency.pdf}
\caption{Entidades responsáveis pelo armazenamento de informações de Países, seus idiomas e suas moedas.} \label{hash}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height=0.98\textheight,width=1\textwidth]{MER_-_Goods.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.85\textheight,width=1\textwidth]{MER_-_Release.pdf}
...
\begin{figure}[H]
\centering
\includegraphics[height=0.95\textheight,width=1\textwidth]{MER_-_Version.pdf}
