...
CREATE TABLE social_type (
  ...
  website_secure VARCHAR(255) NULL,
  PRIMARY KEY(id)
);
...
CREATE TABLE users (
  ...
  signup_date DATETIME DEFAULT now() NOT NULL,
  activated BIT DEFAULT 1 NULL,
  PRIMARY KEY(id)
);
...
CREATE TABLE requirements (
  id BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
  video_board VARCHAR(250) NULL,
  processor VARCHAR(250) NULL,
  memory VARCHAR(50) NULL,
  hd_storage VARCHAR(50) NULL,
  PRIMARY KEY(id)
);
