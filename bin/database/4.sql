...
CREATE TABLE image_has_collaborator (
  image_id BIGINT UNSIGNED NOT NULL,
  collaborator_id INTEGER UNSIGNED NOT NULL,
  PRIMARY KEY(image_id, collaborator_id),
  INDEX image_has_collaborator_FKIndex1(image_id),
  INDEX image_has_collaborator_FKIndex2(collaborator_id),
...
CREATE TABLE mod_release (
  id INTEGER UNSIGNED NOT NULL AUTO_INCREMENT,
  entity_release_id BIGINT UNSIGNED NOT NULL,
  mod_release_type_id INTEGER UNSIGNED NOT NULL,
  name VARCHAR NOT NULL,
  ...
  PRIMARY KEY(id),
  INDEX mod_FKIndex2(mod_release_type_id),
  INDEX mod_FKIndex2(entity_release_id),
  FOREIGN KEY(mod_release_type_id)
